import{GY as te,rK as ie,vg as re,rG as ae,qh as se,qi as oe,I$ as o,Dz as ne,J2 as ce,Fq as le,AT as y,Mo as pe,qj as de,Hh as R,tH as he,KW as ve,q5 as ue,qd as me,q6 as fe,vh as U,oB as E,AW as ge,kL as Se,ox as Pe,gc as ye,o3 as _e,I2 as we,Ip as xe,jD as ze,fr as C,NX as I,n7 as $e,Fl as B,si as M,rH as be,xY as ke,Hg as Ve,AX as Oe,vi as H,kM as Y,rL as Te,qk as We,Hi as De,jA as d,lT as Ce,J3 as Le,vd as m,G6 as Me,Dx as L,sv as je,oC as G,BY as Ae,qf as Fe,J4 as Ne,q8 as qe,JO as J,c1 as Re,gW as K,zs as X,eL as Ue}from"./index-D-fiiKLr.js";function Q(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:x}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
