import{ko as Pe,mG as be,pH as we,Ez as f,pw as w,pC as De,pp as B,Ia as r,Fr as U,Gc as Q,Bk as Ve,pt as C,op as ee,iT as R,jx as F,pI as xe,BL as te,EG as ie,pr as M,bp as m,Am as v,MS as ne,zA as se,ys as o,AB as ae,hB as Ee,u_ as Le,fo as ye,lx as re,yJ as le,Kp as Se,Ii as Ce,tL as Me,Ig as Ae,px as $e,zN as H,oh as Re,rA as oe,Ib as ce,jh as he,lZ as Te,Dx as G,Kq as q,je as c,lo as z,Hj as de,fR as pe,of as Oe,IY as O,iY as Ie,EC as qe,DM as je,kq as Ue,u6 as V,kp as ze,rD as k,EL as Ne,DO as We,CF as T,Bm as Be,xu as Fe,KC as He,f0 as Ge,BN as ke,kO as Ke,t7 as Xe,jj as A,lc as Ye,H3 as K}from"./index-DbhcC6ny.js";import{t as Ze}from"./VisualElement-XXj4eixI.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const N=U(6);function fe(t){const e=new Q;e.include(Ve),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new f("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
...
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new M("angleCutoff",i=>$(i)),new C("lineVerticalPlane",(i,s)=>Qe(i,s)),new w("lineVerticalStart",(i,s)=>et(i,s)),new w("lineVerticalEnd",(i,s)=>tt(i,s))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function $(t){return ae(it,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-U(2))))}function Je(t,e){return m(I,t.pointDistanceOrigin,e.camera.viewMatrix),I[3]=te(t.pointDistanceOrigin,t.pointDistanceTarget),I}function Qe(t,e){const n=Le(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,nt),s=R(D,t.lineVerticalPlaneSegment.vector),a=ye(u,i,s);return R(a,a),ge(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function et(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function tt(t,e){const n=re(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),m(n,n,e.camera.viewMatrix)}function ge(t,e,n){return m(X,t,n),v(d,e),d[3]=0,ne(d,d,n),Ee(X,d,st)}const it=le(),u=o(),d=se(),nt=o(),D=o(),X=o(),st=Se(),I=se(),at=Object.freeze(Object.defineProperty({__proto__:null,build:fe,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new Q;e.include(ue,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Ce("modelView",(a,{camera:l})=>Me(lt,l.viewMatrix,a.origin)),new Ae("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new $e("pixelToNDC",({camera:a})=>ae(rt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
