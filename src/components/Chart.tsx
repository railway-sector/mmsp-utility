...
const Chart = () => {
  ...
  useEffect(() => {
    queryc.qValues = [stations, companies, ptLinetypes];
    queryc.qFields = [station_field, company_field, utilTypeField];
  ...
  }, [stations, companies, ptLinetypes]);
